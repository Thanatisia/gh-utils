...
class GitHubClone():
    def __init__(self, GIT_REPO_AUTHOR="",
        ...
        self.GIT_REMOTE_REPO_SERVER_PROTOCOL = os.getenv("GIT_REMOTE_REPO_SERVER_PROTOCOL", "https")
        self.GIT_REMOTE_REPO_SERVER_DOMAIN = os.getenv("GIT_REMOTE_REPO_SERVER_DOMAIN", "github.com")

        ## Repository records
        self.REPO_NAMES_DB_FILE_PATH = os.getenv("REPO_NAMES_DB_FILE_PATH", "docs/records")
        self.REPO_NAMES_DB_FILE_NAME = os.getenv("REPO_NAMES_DB_FILE_NAME", "all-repos.txt")

        ## Local Repository directory
        self.REPO_DIR = os.getenv("REPO_DIR", "repos") # Repository storage directory
        self.REPO_EXPORT_LOGS_FILE_PATH = os.getenv("REPO_EXPORT_LOGS_FILE_PATH", "docs/exports") # Export logs filepath
        self.REPO_EXPORT_LOGS_FILE_NAME = os.getenv("REPO_EXPORT_LOGS_FILE_NAME", "exports.log")  # Export logs filename
        ...
        self.PUBLIC_REPO_DIR="{}/Public".format(REPO_DIR)
        self.PRIVATE_REPO_DIR="{}/Private".format(REPO_DIR)
